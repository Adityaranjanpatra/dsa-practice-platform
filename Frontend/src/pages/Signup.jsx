      ...
      >
        ...
        <div className="text-lg font-semibold gap-2.5 flex flex-col w-full  items-center">
          <div className="flex flex-col  gap-2.5 w-full items-center">
            ...
            <input
              type="text"
              className={`input ${errors.firstName && "input-error"} text-lg font-normal` }
          ...
          <div className="flex relative flex-col gap-2.5 w-full items-center">
